...
namespace UnityEngine.XR.Interaction.Toolkit.Samples.StarterAssets
{
	...
	public class DynamicMoveProvider : ActionBasedContinuousMoveProvider
	{
		...
		[Space] [Header("Movement Direction")] [SerializeField] [Tooltip("Directs the XR Origin's movement when using the head-relative mode. If not set, will automatically find and use the XR Origin Camera.")]
		private Transform m_HeadTransform;

		[SerializeField] [Tooltip("Directs the XR Origin's movement when using the hand-relative mode with the left hand.")]
		private Transform m_LeftControllerTransform;

		[SerializeField] [Tooltip("Directs the XR Origin's movement when using the hand-relative mode with the right hand.")]
		private Transform m_RightControllerTransform;

		[SerializeField] [Tooltip("Whether to use the specified head transform or left controller transform to direct the XR Origin's movement for the left hand.")]
		private MovementDirection m_LeftHandMovementDirection;

		[SerializeField] [Tooltip("Whether to use the specified head transform or right controller transform to direct the XR Origin's movement for the right hand.")]
		...
		/// <summary>
		/// Directs the XR Origin's movement when using the head-relative mode. If not set, will automatically find and use the XR
		/// Origin Camera.
		/// </summary>
		...
		/// <summary>
		/// Whether to use the specified head transform or controller transform to direct the XR Origin's movement for the right
		/// hand.
		/// </summary>
		/// <seealso cref="MovementDirection"/>
